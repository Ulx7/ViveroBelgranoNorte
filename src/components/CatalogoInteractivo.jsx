...
const RedesSociales = () => (
    <div className="flex items-center gap-3 bg-white/40 px-3 py-1.5 rounded-full border border-white/20 shrink-0 overflow-x-auto no-scrollbar max-w-[85px] sm:max-w-none transition-all duration-300">
        ...
        <a href="https://www.instagram.com/viverobelgranonorte?igsh=MXRkMjlrYXd0amFzdA==" target="_blank" className="text-[#6B5E4C] hover:text-[#8A9A5B] transition-colors scale-90 shrink-0">
        ...
        <a href="https://www.tiktok.com/@viverobelgranonorte?_r=1&_t=ZS-95UdNlkWCdV" target="_blank" className="text-[#6B5E4C] hover:text-[#8A9A5B] transition-colors scale-90 shrink-0 opacity-60">
