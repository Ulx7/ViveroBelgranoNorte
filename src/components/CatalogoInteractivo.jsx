...
const RedesSociales = () => (
    <div className="flex items-center gap-2 md:gap-3.5 bg-white/40 px-2.5 py-1.5 rounded-full border border-white/20 shrink-0 overflow-x-auto no-scrollbar max-w-[140px] sm:max-w-none">
        ...
        <a href="https://www.instagram.com/viverobelgranonorte?igsh=MXRkMjlrYXd0amFzdA==" target="_blank" className="text-[#6B5E4C] hover:text-[#8A9A5B] transition-colors scale-90 shrink-0 opacity-60 hover:opacity-100">
        ...
        <a href="https://www.tiktok.com/@viverobelgranonorte?_r=1&_t=ZS-95UdNlkWCdV" target="_blank" className="text-[#6B5E4C] hover:text-[#8A9A5B] transition-colors scale-90 shrink-0 opacity-60 hover:opacity-100">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04-.1z" /></svg>
        </a>
        <a href="https://www.facebook.com/share/1CZkVvrWnR/" target="_blank" className="text-[#6B5E4C] hover:text-[#1877F2] transition-colors scale-90 shrink-0 opacity-60 hover:opacity-100">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="shrink-0">
                            <a href="/" className="flex items-center gap-2 group">
                                ...
                                <span className="text-[10px] uppercase tracking-widest font-black text-[#6B5E4C] xs:block">Inicio</span>
                            </a>
                        </div>
